...
```{r, warning=FALSE, message=FALSE, fig.cap="Figure 9. Across all treatments grass DPM height (cm) in fenced plots were on average 0.84 taller than those in unfenced plots (p < 0.0001), indicating a strong overall effect of fencing on grass height at SHR."}
