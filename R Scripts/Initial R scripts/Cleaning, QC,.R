...
Treesdata <- read_csv("C:/Users/tg488/OneDrive - University of Exeter/Project developement - Taps/CSV. files/Woody2.csv")
head(Treesdata)
...
Grassesdata2 <- read_csv("C:/Users/tg488/OneDrive - University of Exeter/Project developement - Taps/CSV. files/Grasses2 - Copy.csv")
head(Grassesdata2)
...
###### saving cleaned data
write_csv("Grassesdata2, C:/Users/tg488/OneDrive - University of Exeter/Project developement - Taps/CSV. files/Grasses2 - Copy.csv")
...
grassheightNN <- read_csv("C:/Users/tg488/OneDrive - University of Exeter/Project developement - Taps/CSV. files/Grass HEIGHT only.csv")
head(grassheightNN)
